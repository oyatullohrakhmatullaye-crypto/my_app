            ...
            if (products.isEmpty)
              ...
              DropdownButtonFormField<String>(
                ...
                decoration: const InputDecoration(
                    labelText: 'Mahsulot', border: OutlineInputBorder()),
                items: products
                    .map(
                      (p) => DropdownMenuItem(
                        value: p.id,
              ...
              Row(
                children: [
                  ...
                  IconButton(
                    onPressed: selected != null && _qty < selected.quantity
                        ? () => setState(() => _qty++)
                        : null,
              ...
              FilledButton(
                ...
                child:
                    const Text('Brakga berish', style: TextStyle(fontSize: 18)),
              ),
            ],
          ],
          if (admin) ...[
            const Text('Brak ro‘yxati (admin)',
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
            const SizedBox(height: 8),
            ...shop.defects.map((d) {
              return Card(
                child: ListTile(
                  ...
                  subtitle: Text(
                      '${d.workerName} · ${d.note ?? ""} ${d.recovered ? "· qaytarilgan" : ""}'),
